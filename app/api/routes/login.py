...
def recover_password(email: str, session: SessionDep) -> Message:
    ...
    password_reset_url = f"{settings.server_host}/reset-password?token={password_reset_token}"
    ...
    debug_print(f"Use this token for password reset: {password_reset_token}")
    debug_print(f"Use this as password reset URL: {password_reset_url}")
